...
st.set_page_config(page_title="Autism Science Foundation (ASF)", layout="wide")
st.header("Autism Science Foundation (ASF)")
...
with open('./data/graph_ASF.pkl', 'rb') as f:
    G = pickle.load(f)

with open('./data/semantic_dict_ASF.pkl', 'rb') as f:
...
root_org_user = 'AutismScienceFd'.lower()
